  ...
  return (
    <div className="tw-dark tw-font-roboto_mono tw-min-h-[40em]">
      <div
        className={`${
          darkMode
            ? 'tw-bg-[url(../assets/bg/sw-1.jpg),_url(../assets/bg/landscape.jpg)] tw-bg-blend-overlay tw-bg-blend-darken tw-brightness-60'
            : 'tw-bg-[url(../assets/bg/sw-1.jpg),_url(../assets/bg/landscape.jpg)] tw-bg-blend-overlay tw-opacity-50'
      ...
      <article className="tw-relative tw-h-screen tw-w-screen tw-flex tw-flex-col tw-min-h-[40em]">
        ...
        >
          <div
            ...
            className={`${
              darkMode
                ? 'tw-border-neutral-700 tw-bg-campfire-neutral-700/70 '
                : 'tw-bg-campfire-neutral-50/70 tw-border-campfire-neutral-100'
            } tw-w-full tw-h-[3em] tw-pl-4 tw-flex tw-flex-row tw-items-center tw-justify-between tw-font-space_mono tw-border-b`}
          >
            <Transition>
