...
/**Components */
import HomeBanner from '../../components/dashboard/D_Banner';
/**Hooks */
import Transition from '../../hooks/useTransition';
import useWindowSize from '../../hooks/useWindowSize';

const Layout_D_Banner = () => {
        ...
        <li>
          <Transition>
            <h6 className={`${darkMode ? '' : ''} tw-font-space_mono_bold`}>
              1.
              <span
                className={`${darkMode ? '' : ''} tw-decoration-campfire-purple-light tw-underline 
...
export default Layout_D_Banner;
