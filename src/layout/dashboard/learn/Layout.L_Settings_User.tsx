...
/**Custom Components*/
import L_Settings_User from '../../../components/dashboard/learn/learn-settings/L_Settings_User';

const Layout_L_Settings_User = () => {
  /**Custom Hooks */
...
export default Layout_L_Settings_User;
