...
const D_Languages = () => {
  ...
  return (
    <div>
      <menu className={`${darkMode ? 'tw-text-campfire-neutral-400' : 'tw-text-campfire-neutral-800'} tw-flex tw-flex-row tw-h-full tw-w-full tw-text-campfire-blue tw-items-center tw-place-content-start`}>
