...
const L_Route_User_Editor = () => {
  ...
  return (
    <menu
      className={`${
        darkMode ? 'tw-text-campfire-blue' : 'tw-text-campfire-neutral-800'
      } tw-shrink-0 tw-flex tw-flex-row tw-h-full tw-w-full tw-text-campfire-blue tw-items-center tw-place-content-between tw-pr-3 `}
    >
      {isMobile ? (
        <ul>
...
export default L_Route_User_Editor;
