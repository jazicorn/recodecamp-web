      ...
      <menu className={`tw-h-full tw-pt-1`}>
        <Transition>
          <ul className="tw-flex tw-flex-row tw-items-center ">
            <li className="">
              <img src={Trophy} alt="Trophy" style={{ height: 18, width: 36 }}></img>
            </li>
            <li className="tw-text-campfire-purple">
              Total<span className="tw-text-campfire-neutral-900">:</span>
            </li>
