...
const L_SubCategory = (subCategory) => {
  ...
  return (
    <div className={`tw-w-full tw-h-full tw-flex tw-flex-col tw-flex-wrap tw-grow tw-p-2`}>
      <ul
        className={`${
          darkMode ? 'tw-bg-campfire-neutral-600/70' : 'tw-bg-campfire-neutral-200/70'
        } tw-h-full tw-flex tw-flex-wrap`}
      >
        {routes === undefined ? (
          <div />
        ) : (
          <div className="tw-flex tw-flex-row tw-flex-wrap ">
            <Transition>
              <h6
                className={`${
                  darkMode
                    ? 'tw-bg-campfire-neutral-500/70'
                    : 'tw-border-campfire-neutral-500 tw-bg-campfire-neutral-100/70'
                } tw-mb-1 tw-min-w-[8em] tw-mr-1 tw-px-1 tw-pb-1 tw-text-base tw-border-b`}
              >
                {sub[0]}:
              </h6>
            </Transition>
              ...
              {routes.map((route, i) => {
                ...
                return (
                  <button
                    ...
                    className={`${
                      darkMode
                        ? 'hover:tw-bg-campfire-neutral-200/70 tw-text-campfire-blue'
                  ...
                  >
                    <span className="tw-px-2 tw-pt-0.5 tw-text-sm tw-font-space_grotesk_bold">
