...
var Button_User_Login = function () {
  ...
  /** Guest AuthMe */
  var guestAuthMe = (0, react_1.useCallback)(function (e) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3]);
            return [4 /*yield*/, dispatch((0, authSlice_ts_1.userAuthMe)()).unwrap()];
          case 1:
            ...
            if (originalPromiseResult === undefined || originalPromiseResult.error) {
              ...
              notifications_1.notifications.show({
                ...
                color: 'teal',
                icon: <react_emojis_1.default emoji="beaming-face-with-smiling-eyes" />,
...
exports.default = Button_User_Login;
