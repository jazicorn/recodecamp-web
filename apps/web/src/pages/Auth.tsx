...
const Auth = () => {
  ...
  return (
    <div className='tw-dark tw-font-roboto_mono tw-min-h-[40em]'>
      <div className={`${darkMode ? 'tw-bg-[url(../assets/bg/sw-1.jpg),_url(../assets/bg/landscape.jpg)] tw-bg-blend-overlay tw-bg-blend-darken tw-brightness-50': 
                  ...
                  <Transition>
                    ...
                    <ul className="tw-flex tw-flex-row tw-items-center ">
                        ...
                        <li>
                            ...
                            <Transition><Sun style={{ height: 26, width: 26 }} /></Transition>
                            </button>
                        </li>
                        ) : (
                        <li>
                            <button className="tw-pt-1 tw-place-self-center" onClick={toggleTheme}>
                            <Transition><Moon style={{ height: 26, width: 26 }} /></Transition>
                            </button>
                        </li>
                        )}
                    </ul>
